<!-- <?php
// setcookie("name","jane",time()+3600);// 3600 代表秒數
// // print($_COOKIE["name"]);
...
//     $sql = 'INSERT INTO member(loginemail,password, realname,sex,skill,year,phonenumber,epaper) VALUES (?,?,?,?,?,?,?,?)';
...
//              <script>
//                 alert('註冊成功，請登入');
//                 window.location.replace('../0214/login.html');
//              </script>    
//             ";
//         // echo "註冊成功";
//         //throw $th;
...
//         <script>
//             alert('註冊失敗');
//             window.location.replace('../0214/signin.html');
//         </script>
//         ";
//     }
